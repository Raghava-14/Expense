...
const HomePage = () => {
  return (
    ...
    <div>
        <div> 
            ...
            <div><h1>Welcome to Expense Tracker </h1>
                <p>The ultimate tool for managing your personal finances.</p> 
                <Link to="/register" className="register-link">Get Started</Link>               
            </div>
            <div class="credit-card">
	<div class="card__info">
		<div class="card__logo">Expense Tracker</div>
		...
		<div class="card__name" aria-label="Dee Stroyer">@expenses</div>
		<div class="card__vendor" role="img" aria-labelledby="card-vendor">
			<span id="card-vendor" class="card__vendor-sr">ExpenseTracker</span>
		</div>
	</div>
	<div class="card__texture"></div>
        ...
        <div>
        <div class="container">
            <p class="container-title">Features we are proud of </p>
            ...
            <div class="gradient-cards">
                ...
                <div class="container-card bg-green-box">
                    ...
                    <p class="card-title">Zero-cost </p>
                    <p class="card-description">Expense Tracker is zero cost, you will never be asked to pay or get a subscription to add expenses!</p>
                </div>
                </div>
        ...
        <div class="container-card bg-white-box">
            ...
            <p class="card-title">Multi-Investment Tracking</p>
            <p class="card-description">You can keep track of all your different investments at one place!</p>
        </div>
        </div>
        ...
        <div>
            <p class="container-title">Customer Reviews</p>
        </div>
        <div className='testimonials'>
            
        <figure class="snip1157">
            <blockquote>Expense Tracker has changed the way I manage my finances. It's simple and effective.
                <div class="arrow"></div>
            </blockquote>
        ...
        <figure class="snip1157">
            <blockquote>The group expenses feature is a game-changer for splitting bills. Love it!<div class="arrow"></div>
            </blockquote>
        ...
        <figure class="snip1157">
            <blockquote>Best financial planning application ever!! Exponetially increased my investments.
                <div class="arrow"></div>
            </blockquote>
