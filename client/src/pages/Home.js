        ...
        <div className="flex justify-around flex-wrap">
          <div className="max-w-sm">
            <div className="text-center mb-4 opacity-75">
              <img src={insights} alt="Insights" className="w-16 h-16 mx-auto"/>
            </div>
            <p>Visualize spending with beautiful charts and insights.</p>
          </div>
          <div className="max-w-sm">
            <div className="text-center mb-4 opacity-75">
              <img src={group} alt="Groups" className="w-16 h-16 mx-auto"/>
            </div>
            <p>Manage group expenses easily with friends and family.</p>
          </div>
          <div className="max-w-sm">
            <div className="text-center mb-4 opacity-75">
              <img src={easy} alt="On-the-go" className="w-16 h-16 mx-auto"/>
            </div>
